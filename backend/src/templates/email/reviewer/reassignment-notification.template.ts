...
export function generateReviewerReassignmentNotificationHtml(data: {
  ...
  const content = `
    <div style="padding: 30px;">
      ...
      <p>We wanted to inform you that the article <strong>"${data.articleTitle}"</strong> has been reassigned to another reviewer.</p>
      ...
      <p>Thank you for your time and consideration. We appreciate your continued support as a reviewer for Law Nation.</p>
