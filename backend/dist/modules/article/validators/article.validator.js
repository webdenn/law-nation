...
export const articleSubmissionSchema = z.object({
    ...
    authorName: z.string()
        ...
        .regex(/^[a-zA-Z\s]+$/, "Author name can only contain letters and spaces (no numbers, special characters, or punctuation allowed)"),
    ...
    secondAuthorName: z.string()
        ...
        .regex(/^[a-zA-Z\s]+$/, "Second author name can only contain letters and spaces (no numbers, special characters, or punctuation allowed)")
        .optional(),
    ...
    title: z.string()
        ...
        .regex(/^[a-zA-Z\s\-:,.'&()]+$/, "Title can only contain letters, spaces, and basic punctuation (- : , . ' & ( ))"),
