 ...
 */
export async function generateVisualDiffPdf(originalPdfPath, modifiedPdfPath, outputPath) {
    ...
    try {
        ...
        const highlightedPdfPath = await generateHighlightedPdf(originalPdfPath, modifiedPdfPath, outputPath);
 ...
 * @returns Path to generated highlighted PDF
 */
export async function generateVisualDiffFromChangeLog(changeLogId, articleId, versionNumber, originalPdfPath, modifiedPdfPath, outputPath) {
...
//# sourceMappingURL=pdf-visual-diff.utils.js.map