 ...
 */
export async function generateOverlayApiResponse(originalPdfPath, editedPdfPath, baseUrl = '') {
    ...
    try {
        ...
        const overlayResult = await generateOverlayVisualDiff(originalPdfPath, editedPdfPath);
 ...
 */
export async function generateTestOverlayApiResponse(editedPdfPath, baseUrl = '') {
...
//# sourceMappingURL=overlay-api.utils.js.map