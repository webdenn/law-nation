 ...
 */
export async function addWatermarkToWord(wordPath, watermarkData) {
    try {
 ...
 */
export async function addSimpleWatermarkToWord(wordPath, watermarkData) {
    try {
...
//# sourceMappingURL=word-watermark.utils.js.map