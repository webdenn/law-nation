...
export async function generateDiffPdf(diffData, options) {
    return new Promise((resolve, reject) => {
        try {
            ...
            for (let i = 0; i < pageCount; i++) {
                ...
                doc.text(`Law Nation - Diff Report | Page ${i + 1} of ${pageCount}`, 50, 792 - 30, { align: 'center', width: 500 });
            }
            // Finalize PDF
            doc.end();
        }
 ...
 */
export function generateDiffText(diffData) {
...
//# sourceMappingURL=diff-pdf-generator.utils.js.map