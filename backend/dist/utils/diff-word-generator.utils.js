 ...
 */
export async function generateDiffWord(diffData, options) {
    try {
        console.log(`📝 [Word Diff] Generating Word document...`);
        ...
        sections.push(new Paragraph({
            children: [
                new TextRun({
                    text: `Version ${options.versionFrom} → Version ${options.versionTo}`,
                    size: 22,
                    color: '666666',
                }),
            ],
        ...
        sections.push(new Paragraph({
            children: [
                new TextRun({
                    text: `✓ ${diffData.summary.totalAdded} lines added`,
                    color: '27ae60',
                    bold: true,
                }),
            ],
        ...
        sections.push(new Paragraph({
            children: [
                new TextRun({
                    text: `✗ ${diffData.summary.totalRemoved} lines removed`,
                    color: 'e74c3c',
                    bold: true,
                }),
            ],
        ...
        sections.push(new Paragraph({
            children: [
                new TextRun({
                    text: `⟳ ${diffData.summary.totalModified} lines modified`,
                    color: 'f39c12',
                    bold: true,
                }),
            ],
        ...
        console.log(`✅ [Word Diff] Generated ${buffer.length} bytes`);
        return buffer;
    }
    catch (error) {
        console.error('❌ [Word Diff] Error generating Word document:', error);
 ...
 */
export async function generateSimpleDiffWord(diffData) {
    const sections = [];
    sections.push(new Paragraph({
        text: 'Diff Report',
        heading: HeadingLevel.HEADING_1,
...
//# sourceMappingURL=diff-word-generator.utils.js.map