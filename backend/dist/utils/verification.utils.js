...
export class VerificationService {
     ...
     */
    static async createVerificationRecord(email, resourceType, metadata, ttlHours = DEFAULT_TTL_HOURS, includeCode = false) {
     ...
     */
    static async markAsVerifiedByCode(email, code) {
        const verification = await prisma.emailVerification.findFirst({
            where: {
                email,
                verificationCode: code,
     ...
     */
    static async deleteVerification(token) {
     ...
     */
    static async deleteVerificationByCode(email, code) {
        const verification = await prisma.emailVerification.findFirst({
            where: {
                email,
                verificationCode: code,
     ...
     */
    static async moveTempFile(tempPath) {
