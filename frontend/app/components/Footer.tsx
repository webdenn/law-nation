        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3 text-[15px]">
              ...
              <li><Link href="/join-law-nation" className="hover:text-red-700 transition-colors">Join Law Nation </Link></li>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-3 text-[15px]">
              ...
              <li><Link href="/terms/author" className="hover:text-red-700 transition-colors"> Terms & Conditions</Link></li>
