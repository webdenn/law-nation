                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <a href="#reviewer-terms" className="text-slate-600 hover:text-red-700 transition-colors flex items-center gap-2">
                            <span className="w-1.5 h-1.5 bg-red-700 rounded-full"></span>
                            Stage 2 Review Terms & Ethical Guidelines
                        </a>
                    </div>
                </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden text-justify">
                        ...
                        <div className="p-8 space-y-8 text-slate-700 leading-relaxed">
                            <div>
                                ...
                                <p>
                                    By accepting an invitation to review an article, analysis, and/or any other material for Law Nation Prime Times Journal (“<strong>LN</strong>”), or by accessing the Stage 2 Review portal, you (“<strong>the Stage 2 Review</strong>”) unequivocally agree to be bound by these Terms and Conditions. These terms are intended to protect the integrity of the double-blind peer review process, the intellectual property of the authors, and the reputation of LN.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mb-4">
                                    The peer review process is confidential and privileged. As a Stage 2 Review, you acknowledge that the article, analysis, and/or any other material provided to you are the exclusive intellectual property of the author(s) until published.
                                </p>
                                <ul className="space-y-3 list-disc pl-6">
                            ...
                            <div>
                                ...
                                <ul className="space-y-3 list-disc pl-6">
                                    <li>If you suspect plagiarism, simultaneous submission to another journal, duplicate publication, or data fabrication, you must report this to the LN Stage 1 Review in strict confidence. Do not investigate the issue personally.</li>
                            ...
                            <div>
                                ...
                                <ul className="space-y-3 list-disc pl-6">
                                    <li>You acknowledge that, unless otherwise agreed in writing, the role of Stage 2 Review is voluntary and uncompensated.</li>
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-slate-900 mb-4">Termination of Stage 2 Review Status</h3>
                                <p>
                                    LN reserves the right to remove a Stage 2 Review from its panel at its sole discretion, without notice, for failure to meet deadlines, producing poor-quality reviews, or breaching these Terms and Conditions.
                                </p>
                            </div>
                        </div>
                    </div>
