...
const ReviewInterface = ({
    ...
    const [previewHtml, setPreviewHtml] = useState(""); // ✅ NEW

    // ✅ PREVIEW MODAL COMPONENT (Copied from Editor)
    const PreviewModal = () => {
        ...
        <div className="flex flex-col lg:flex-row gap-6 h-auto lg:h-full">
            ...
            <div className="flex-1 bg-gray-100 rounded-xl border border-gray-300 p-4 flex flex-col h-[500px] lg:h-auto min-h-[500px]">
                <div className="flex justify-between items-center mb-4">
                    <h3 className="font-bold text-gray-700 uppercase text-sm md:text-base">
                        {pdfViewMode === "original" ? " Stage 1 Reviewer PDF" : " Stage 2 Reviewer PDF"}
                    </h3>
                    {getPdfUrlToView() && (
                        <a
            ...
            <div className="w-full lg:w-[350px] space-y-6 shrink-0 h-full overflow-y-auto pb-10">
                            ...
                            <input
                                ...
                                onChange={(e) => {
                                    ...
                                    if (file) {
                                        ...
                                        setDeclarationAccepted(false); // Reset confirmation
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
                    <h3 className="font-bold text-gray-800 mb-4">Stage 1 Reviewer Document</h3>
                            ...
                            <button
                                onClick={() =>
                                    handleDownloadFile(
                                        ...
                                        selectedArticle.title + "_stage_1_reviewer_version",
                                        "Word"
                                    )
                                }
