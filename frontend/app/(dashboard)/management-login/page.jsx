  ...
  return (
    <div className="h-screen flex overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-br from-red-600 to-red-900" />
        ...
        <div className="relative z-10 flex flex-col justify-center items-start px-10 xl:px-14 text-white">
          ...
          <p className="text-lg xl:text-xl text-white/90 font-light leading-relaxed max-w-md">
            Sign in to access the Admin Panel and manage Law Nation submissions securely. (Stage 1 & Stage 2 Review permitted)
          </p>
        </div>
      </div>
