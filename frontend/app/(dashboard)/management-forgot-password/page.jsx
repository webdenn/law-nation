...
export default function ManagementForgotPassword() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${NEXT_PUBLIC_BASE_URL}/auth/forgot-password`, {
                method: "POST",
    ...
    return (
        <div className="h-screen flex overflow-hidden">
            {/* Left Side - Visual Section (Red Branded) */}
                ...
                <div className="relative z-10 flex flex-col justify-center items-start px-10 xl:px-14 text-white">
                    <div>
                        ...
                        <p className="text-lg xl:text-xl text-white/90 font-light leading-relaxed max-w-md">
                            Forgot your management access password? Enter your email to reset it.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center bg-gray-50 px-4 sm:px-6 lg:px-10 xl:px-12 py-6 overflow-y-auto">
                <div className="w-full max-w-md">
                    <div className="lg:hidden text-center mb-6">
                        ...
                        <p className="text-sm text-gray-600">Recover your management account</p>
                    </div>
